    ...
    def enrich_attractions(self, limit=None):
        ...
        for i, attraction in enumerate(attractions, 1):
            ...
            try:
                ...
                # 生成门票价格（如果没有）
                if not attraction.ticket_price or attraction.ticket_price == 0:
                    # 根据城市和类型生成合理价格
                    if '公园' in attraction.name or '广场' in attraction.name:
                        attraction.ticket_price = 0  # 免费
                    else:
                        attraction.ticket_price = random.choice([30, 40, 50, 60, 80, 100, 120])
